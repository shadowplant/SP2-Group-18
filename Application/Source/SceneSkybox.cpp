...
void SceneSkybox::Init()
{
	...
	meshList[GEO_QUAD] = MeshBuilder::GenerateQuad("nyp", Color(1, 1, 1), 1.f, 1.f);
	meshList[GEO_QUAD]->textureID = LoadTGA("Image//NYP.tga");

	meshList[GEO_FLOOR] = MeshBuilder::GenerateQuad("floor", Color(1, 1, 1), 1.f, 1.f);
	meshList[GEO_FLOOR]->textureID = LoadTGA("Image//color.tga");
	...
	meshList[GEO_SPHERE] = MeshBuilder::GenerateSphere("sphere", Color(1, 1, 1), 50, 100, 1);
...
void SceneSkybox::Exit()
{
	...
	delete meshList[GEO_MODEL1];
	delete meshList[GEO_LIGHTBALL];
	delete meshList[GEO_FLOOR];
	delete meshList[GEO_MODEL6];
	delete meshList[GEO_MODEL7];
	delete meshList[GEO_MODEL8];
